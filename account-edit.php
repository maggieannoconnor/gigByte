            ...
            if (isset($_SESSION["id"])) {
                ...
                if ($userAttributes !== false) {
                    ...
                    <div class="container form-section">
                        ...
                        <form name="editUserForm" action="account-edit.php" method="post">
                            ...
                            <div class="form-buttons">
                                <button type="submit"  class="btn" style="background-color: #232D4B; color:white;"  name="updateUserBtn">Update</button>
                            </div>
                        </form>
                    </div>
                    <?php
